...
return [
    ...
    'enable_auto_restock' => 'Enable auto restocking',
    'auto_restock_help_text' => 'Automatically create purchase requisitions for low-stock products based on alert quantity and current stock.',
    'auto_restock_target_factor' => 'Auto restock target factor',
    'auto_restock_target_factor_help' => 'Target stock = alert quantity x factor. For example, factor 1.5 means restock up to 150% of the alert quantity.',
    'auto_restock_delivery_days' => 'Auto restock delivery lead days',
    'auto_restock_delivery_days_help' => 'Set expected delivery date by adding these days to the auto-generated requisition date.',
    ...
    'gift_card_number_auto' => 'Auto generate if empty',
    'gift_card_number_auto_help' => 'Leave empty to auto-generate a unique gift card number',
    'gift_card_number_exists' => 'This gift card number already exists',
    'gift_card_issue_amount' => 'Issue Amount',
    'gift_card_bonus_amount' => 'Promotional Bonus',
    'gift_card_bonus_help' => 'Use bonus amount for promotional gift card campaigns',
    'gift_card_expiry_date' => 'Expiry Date',
    'gift_card_transactions' => 'Gift Card Transactions',
    'gift_card_details' => 'Gift Card Details',
    'gift_card_issued_successfully' => 'Gift card issued successfully',
    'gift_card_not_found' => 'Gift card was not found',
    'gift_card_not_usable' => 'Gift card is not active',
    'gift_card_expired' => 'Gift card is expired',
    'gift_card_insufficient_balance' => 'Gift card does not have sufficient balance',
    'gift_card_balance' => 'Gift Card Balance',
    'gift_card_issue_entry' => 'Gift card issued',
    'gift_card_bonus_entry' => 'Promotional bonus added',
    'gift_card_redeem_entry' => 'Amount redeemed in sale',
    'gift_card_reversal_entry' => 'Redeemed amount reversed',
    'gift_card_status_active' => 'Active',
    'gift_card_status_inactive' => 'Inactive',
    'gift_card_status_expired' => 'Expired',
    'gift_card_status_updated' => 'Gift card status updated',
    'gift_card_expired_cannot_activate' => 'Expired gift card cannot be activated',
    ...
    'back_to_gift_cards' => 'Back to Gift Cards',
    'gift_card_help_title' => 'How gift cards work in this system',
    'gift_card_help_issue' => 'Issue Gift Card loads value onto the card (store credit). This screen does not automatically record that the customer paid you with cash or card—that is done with a normal sale on POS if you need it in your accounts.',
    'gift_card_help_customer_pays' => 'When a customer buys a card: ring a POS sale for the price (for example a product named “Gift card”), take payment as Cash, Card, or another real method, then issue the card here for the same amount—or issue first if your process is to collect payment separately.',
    'gift_card_help_redeem' => 'When they spend it: on POS, add a payment line, choose Gift Card as the method, enter the card number (e.g. GC-…), and set the amount to apply. The balance updates automatically and appears in this card’s transaction history.',
    'gift_card_help_pos_toggle' => 'If “Gift Card” is missing in the POS payment dropdown: Business Settings → Business Locations → edit the location → Payment methods → enable Gift Card.',
    'gift_card_help_pos_auto_amount' => 'On POS, when payment method is Gift Card, entering the card number checks the balance and fills the payment amount (up to what is still due on the bill). The orange “Balance” line shows what you still need to collect in cash or card.',
    'gift_card_linked_pos_sale' => 'Link to POS sale (optional)',
    'gift_card_linked_pos_sale_help' => 'After the customer pays on POS, type the invoice number from the receipt or sales list (e.g. 0006). The system looks up that sale and stores the link automatically.',
    'gift_card_linked_sale_placeholder' => 'e.g. 0006 (invoice no. from receipt / sales list)',
    'gift_card_invoice_not_found' => 'No completed sale found for invoice or reference “:invoice”. Check the number and try again.',
    'gift_card_invalid_linked_sale' => 'That sale ID was not found or is not a completed POS sale for your business.',
    'gift_card_linked_sale_short' => 'Paid sale',
    'gift_card_view_sale' => 'View sale',
    'deactivate' => 'Deactivate',
    'activate' => 'Activate',
    ...
    'loyalty_program_analytics' => 'Loyalty Program Analytics',
    'current_loyalty_tier' => 'Current Loyalty Tier',
    'tier_not_assigned' => 'Tier not assigned',
    'esl_integration' => 'ESL Integration',
    'weighing_scale_live' => 'Live Weighing Scale',
    'test_connection' => 'Test Connection',
    'read_from_scale' => 'Read From Scale',
