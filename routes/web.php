...
use App\Http\Controllers\LoyaltyAnalyticsController;
use App\Http\Controllers\LoyaltyTierController;
use App\Http\Controllers\GroupTaxController;
use App\Http\Controllers\GiftCardController;
use App\Http\Controllers\HardwareIntegrationController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/promotions/validate-cart', [PromotionController::class, 'validateCartPromotion'])->name('promotions.validate-cart');
    Route::post('/integrations/esl/test', [HardwareIntegrationController::class, 'testEslConnection'])->name('integrations.esl.test');
    Route::post('/integrations/esl/sync-product/{id}', [HardwareIntegrationController::class, 'syncProductToEsl'])->name('integrations.esl.sync-product');
    Route::get('/integrations/scale/read', [HardwareIntegrationController::class, 'readFromScale'])->name('integrations.scale.read');
    Route::get('/loyalty-tiers', [LoyaltyTierController::class, 'index']);
    Route::post('/loyalty-tiers', [LoyaltyTierController::class, 'store']);
    Route::put('/loyalty-tiers/{id}', [LoyaltyTierController::class, 'update']);
    Route::get('/reports/loyalty-analytics', [LoyaltyAnalyticsController::class, 'index']);
    Route::get('/gift-cards', [GiftCardController::class, 'index']);
    Route::post('/gift-cards', [GiftCardController::class, 'store']);
    Route::post('/gift-cards/lookup-balance', [GiftCardController::class, 'lookupBalance']);
    Route::get('/gift-cards/{id}', [GiftCardController::class, 'show']);
    Route::post('/gift-cards/{id}/toggle-status', [GiftCardController::class, 'toggleStatus']);
