...
class AdminSidebarMenu
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            $menu->url(action([\App\Http\Controllers\HomeController::class, 'index']), __('home.home'), ['icon' => '<img src="'.asset('images/dashboard-icons/nav/home.png').'" class="tw-size-5 tw-shrink-0" alt="Home" />', 'active' => request()->segment(1) == 'home'])->order(5);
