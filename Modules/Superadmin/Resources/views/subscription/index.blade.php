...
<div class="vp-vendo-page-wrap">
    <div class="vp-vendo-form-page-head">
        <a href="{{ action([\App\Http\Controllers\BusinessController::class, 'getBusinessSettings']) }}" class="vp-vendo-form-back"
            aria-label="{{ __('messages.go_back') }}">
            <img src="{{ asset('images/dashboard-icons/sales-back.png') }}" alt="">
        </a>
        <div class="vp-vendo-form-head-main">
            <h1 class="vp-vendo-form-title">@lang('superadmin::lang.subscription')</h1>
        </div>
    </div>
