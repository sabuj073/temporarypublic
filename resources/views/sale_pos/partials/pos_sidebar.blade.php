...
<div class="vp-pos-browse-shell">
    <div class="vp-pos-browse-toolbar">
        <div id="vp_pos_search_host" class="vp-pos-browse-search-host"></div>
        @if (!empty($brands))
            <div class="vp-pos-browse-toolbar-side">
                <select id="vp_pos_brand_select" class="vp-pos-brand-select" title="@lang('brand.brands')">
                    <option value="">@lang('brand.brands')</option>
    ...
    @if (!empty($categories))
        <div class="vp-pos-browse-section-head">
            <h3 class="vp-pos-browse-section-title">@lang('category.category')</h3>
        </div>
        <div class="vp-pos-category-pills-scroll">
            <button type="button"
                class="vp-pos-category-pill main-category vp-pos-cat-active"
                data-value="all"
                data-parent="0">
                <span class="vp-pos-pill-title">@lang('lang_v1.all_category')</span>
                <span class="vp-pos-pill-count">{{ (int) ($pos_all_category_product_count ?? 0) }} @lang('sale.item')</span>
            </button>
            @foreach ($categories as $category)
                <button type="button" class="vp-pos-category-pill main-category" data-value="{{ $category['id'] }}"
                    data-parent="0">
                    <span class="vp-pos-pill-title">{{ $category['name'] }}</span>
                    <span class="vp-pos-pill-count">{{ (int) ($category['product_count'] ?? 0) }} @lang('sale.item')</span>
                </button>
            @endforeach
        </div>
        ...
        <div class="tw-dw-drawer tw-dw-drawer-end">
            ...
            <div class="tw-dw-drawer-content tw-min-h-0"></div>
    ...
    <div class="vp-pos-browse-section-head vp-pos-items-head">
        <h3 class="vp-pos-browse-section-title">@lang('sale.item')</h3>
    </div>
    <div class="row vp-pos-product-grid-row">
