...
@php
    ...
    $business_location_count = is_countable($business_locations ?? null) ? count($business_locations) : 0;
@endphp
...
<div class="col-md-12 no-print pos-header vp-pos-secondary-toolbar">
