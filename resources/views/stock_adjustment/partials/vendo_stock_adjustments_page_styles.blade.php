<style id="vp-stock-adjustment-vendo-styles">
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-page-head {
        display: flex;
        align-items: center;
        gap: 14px;
        margin: 0 0 16px;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-back {
        width: 40px;
        height: 40px;
        border-radius: 10px;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-back:hover {
        color: #0f172a;
    }

    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-page-title {
        margin: 0;
        font-size: 28px;
        font-weight: 700;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card {
        box-sizing: border-box;
        width: 100%;
        max-width: 100%;
        min-width: 0;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-toolbar {
        display: flex;
        align-items: center;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-title {
        margin: 0;
        font-size: 18px;
        font-weight: 700;
        color: #0f172a;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-toolbar-end {
        display: flex;
        align-items: center;
        gap: 12px;
        flex-wrap: wrap;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-slot .dataTables_length,
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-slot .dataTables_filter {
        float: none;
        margin: 0;
    }

    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-slot .dataTables_length label,
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-slot .dataTables_filter label {
        display: flex;
        align-items: center;
        gap: 8px;
        margin: 0;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-slot .dataTables_length select {
        height: 34px;
        border-radius: 8px;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-filter-slot .dataTables_filter input {
        width: 220px;
        max-width: 42vw;
        height: 36px;
        border-radius: 10px;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-add-btn {
        display: inline-flex;
        align-items: center;
        gap: 8px;
        height: 38px;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-add-btn:hover {
    ...
    body.vp-stock-adjustment-vendo-page #stock_adjustment_table tbody tr:nth-child(even) td {
        background: #fafbfd;
    }

    body.vp-stock-adjustment-vendo-page #stock_adjustment_table tbody td[colspan] {
        width: 100% !important;
    }

    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-footer {
        display: flex;
        align-items: center;
        justify-content: space-between;
        gap: 12px;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-footer .dataTables_info {
        float: none;
        margin: 0;
        padding: 0;
        font-size: 12px;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-footer .dataTables_paginate {
        float: none;
        margin: 0;
        text-align: end;
    }

    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-footer .dataTables_paginate .paginate_button {
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-footer .dataTables_paginate .paginate_button.current,
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-card-footer .dataTables_paginate .paginate_button.current:hover {
        background: linear-gradient(180deg, #1a2b66 0%, #101c3a 100%) !important;
        border-color: #101c3a !important;
        color: #fff !important;
    }

    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-export-dock {
        display: none;
        position: fixed;
        left: 12px;
        right: 12px;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-export-dock.vp-stock-adjustment-export-dock--visible {
        display: flex;
    }

    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-export-inner {
        pointer-events: auto;
        display: flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-export-inner .dt-buttons {
        display: flex;
        flex-wrap: wrap;
        gap: 10px;
        align-items: center;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-export-inner .dt-button {
        background: linear-gradient(180deg, #1a2b66 0%, #101c3a 100%) !important;
        color: #fff !important;
    ...
    body.vp-stock-adjustment-vendo-page .vp-stock-adjustment-export-inner .dt-button:hover {
        filter: brightness(1.06);
        color: #fff !important;
    }
