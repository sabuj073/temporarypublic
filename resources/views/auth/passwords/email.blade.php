    ...
    <div class="vp-login-page-center-wrap">
        ...
        <div class="vp-auth-card tw-mb-4 tw-transition-all tw-duration-200">
            <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                ...
                <h3 class="tw-text-sm tw-font-medium vp-auth-text-muted tw-self-center">@lang('lang_v1.send_password_reset_link')</h3>
                    ...
                    <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
                        <label class="tw-dw-form-control">
                            <div class="tw-dw-label">
                                ...
                                <input id="email" type="email" class="vp-login-input tw-font-medium placeholder:tw-font-medium" name="email" value="{{ old('email') }}" required autofocus placeholder="@lang('lang_v1.email_address')">
